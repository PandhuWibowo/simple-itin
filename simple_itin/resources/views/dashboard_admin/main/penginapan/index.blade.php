...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <a data-toggle="tooltip" title="Add New" class="btn btn-primary btn-flat btn-md" href="{{ url("backend/inn/create") }}">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                @foreach($penginapan as $seq=>$row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('backend/inn/'.$row->penginapan_id.'/edit') }}" class="btn btn-warning btn-md btn-flat btnEditPenginapan" data-toggle="tooltip" title="Edit">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-danger btn-md btn-flat btnRemovePenginapan" data-toggle="tooltip" title="Remove" data-penginapan_id="{{$row->penginapan_id}}">
...
<script src="{!! asset('js/ajax/penginapan.js') !!}"></script>
</body>
</html>
