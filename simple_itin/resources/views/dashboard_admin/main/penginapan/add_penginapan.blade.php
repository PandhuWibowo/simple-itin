            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" autocomplete="off" method="post" action="{{ url('/backend/inn/store') }}" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="nama_wisata">Inn Type</label>
                                    <input type="text" class="form-control" id="nama_penginapan" name="nama_penginapan" placeholder="Inn Name" value="{{Session::get("sess_nama_penginapan")}}">
                                </div>
                                <div class="form-group">
                                    <label>City</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="jenis_penginapan_id" name="jenis_penginapan_id[]" class="form-control jenis_penginapan_id" required multiple="multiple">
                                        ...
                                        @foreach($jenisPenginapan as $v)
                                            <option value="{{$v->jenis_penginapan_id}}">{{$v->nama_jenis_penginapan}}</option>
                                        @endforeach
                                    </select>
                                </div>
