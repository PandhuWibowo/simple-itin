    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Culinary</li>
            </ol>

            <hr>

            <a data-toggle="tooltip" title="Add New" class="btn btn-primary btn-flat btn-md" href="{{ url("backend/culinaries/create") }}">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">Culinary</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                @foreach($kuliner as $seq=>$row)
                                    <tr>
                                        <td>{{$seq+1}}</td>
                                        <td>{{$row->nama_kuliner}}</td>
                                        <td>{{$row->getKota->nama_kota}}</td>
                                        <td>
                                            <a href="{{ url('backend/culinaries/'.$row->kuliner_id.'/edit') }}" class="btn btn-warning btn-md btn-flat btnEditKuliner" data-toggle="tooltip" title="Edit">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-danger btn-md btn-flat btnRemoveKuliner" data-toggle="tooltip" title="Remove" data-kuliner_id="{{$row->kuliner_id}}">
...
<script src="{!! asset('js/ajax/kuliner.js') !!}"></script>
</body>
</html>
