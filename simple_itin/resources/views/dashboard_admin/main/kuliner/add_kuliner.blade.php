            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" autocomplete="off" method="post" action="{{ url('/backend/culinaries/store') }}" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="nama_kuliner">Culinary</label>
                                    <input type="text" class="form-control" id="nama_kuliner" name="nama_kuliner" placeholder="Culinary" value="{{Session::get("sess_kuliner")}}">
                                </div>
                                <div class="form-group">
                                    <label>City</label>
